...
public enum ExportFormat: String, CaseIterable, Sendable {
    ...
    public var displayName: String {
        ...
        case .json: "JSON (Developer-friendly)"
        case .markdown: "Markdown (Documentation)"
        }
    }
}
...
public actor PortExporter {
    ...
    /// Save export to file
    public func saveToFile(_ content: String, filename _: String, format: ExportFormat) -> URL? {
