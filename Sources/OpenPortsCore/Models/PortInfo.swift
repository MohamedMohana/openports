...
public enum PortAge: String, Sendable, Equatable, CaseIterable {
    ...
    public var description: String {
        switch self {
        case .brandNew: "Just started (< 1m)"
        case .new: "Recent (< 5m)"
        case .recent: "Fresh (< 1h)"
        case .established: "Running for a while (< 24h)"
        case .old: "Long-running (>= 24h)"
        }
    }
...
public enum PortSafety: String, Sendable, Equatable, CaseIterable {
    ...
    public var color: String {
        ...
        case .important: "#FF9800"
        case .optional: "#4CAF50"
        case .userCreated: "#2196F3"
        }
    }
    ...
    public var warningMessage: String? {
        switch self {
        case .critical:
            "This is a critical system service. Killing it may cause system instability or network issues."
        case .important:
            "This is an important service. Killing it may require a restart of dependent applications."
        case .optional:
            nil
        case .userCreated:
            "This appears to be a user-created development server. Safe to close."
        }
    }
}
